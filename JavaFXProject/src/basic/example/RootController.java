...
public class RootController implements Initializable {
	...
	Stage primaryStage; //필드생성 
	
	public void setPrimaryStage(Stage primaryStage) { //setPrimaryStage필드이름에 매개값 Stage primaryStage를 받아 접근가능하도록.
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		TableColumn<Student, ?> tc = tableView.getColumns().get(0); // 첫번째 커럶
